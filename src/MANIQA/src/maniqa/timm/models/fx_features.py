...
# NOTE: By default, any modules from maniqa.timm.models.layers that we want to treat as leaf modules go here
# BUT modules from maniqa.timm.models should use the registration mechanism below
_leaf_modules = {
