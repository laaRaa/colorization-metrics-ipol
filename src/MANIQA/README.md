---
noteId: "a293ca50533611f194418f7638caa003"
tags: []
...
This fork introduces the following additions and improvements:

- 📦 **Installable as a pip package**: the codebase has been reorganized into a proper
  Python module that can be installed via:

  ```sh
  pip install git+https://gitlab.inria.fr/nmaignan/MANIQA.git
  ```
...
- 🛑 **Image size check**: a custom exception is now raised when an input image is
  too small to be processed by the model.

These changes aim to ease integration in downstream projects and improve robustness.
